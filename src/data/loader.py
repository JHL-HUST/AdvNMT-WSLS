...
def load_mono_data(params, data):
    ...
    # {
    #   lang1:{[split] : data_path/[split].[lang1].pth, ....}
    #   lang2:{[split] : data_path/[split].[lang2].pth, ....}
    # }
    # 语言是字典的key
...
def check_data_params(params):
    ...
    # MLM / TLM steps
    # 类似以下输入，同时训练MLM模型和XLM模型
    # mlm_steps = [ar, bg, de, el,.....]
    # 'ar,bg,de,el,en,es,fr,hi,ru,sw,th,tr,ur,vi,zh,en-ar,en-bg,en-de,en-el,en-es,en-fr,en-hi,en-ru,en-sw,en-th,en-tr,en-ur,en-vi,en-zh,ar-en,bg-en,de-en,el-en,es-en,fr-en,hi-en,ru-en,sw-en,th-en,tr-en,ur-en,vi-en,zh-en'
    mlm_steps = [s.split('-') for s in params.mlm_steps.split(',') if len(s) > 0]
    # params.mlm_steps: [(ar, None), (bg, None), ..., (en, ar), (en, bg), ...]
